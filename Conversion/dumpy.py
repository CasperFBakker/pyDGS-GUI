...
plt.plot(a)
plt.plot(np.arange(0,1001), a, color='blue')
plt.xticks([0,1000], ["0.180", "0.250"])
for i in range(1001):
    plt.vlines(i, 0, (a[i]), alpha=0.25,color='khaki')
plt.fill_between(np.arange(0,1001), a, alpha=0.1, color='darkkhaki')
plt.ylim([0, 0.0128])
plt.xlim([0, 1000])
...
for i in range(1001):
    plt.vlines(i, 0, (a[i]), alpha=0.25,color='lemonchiffon')
plt.fill_between(np.arange(0,1001), a, alpha=0.1, color='khaki')
plt.ylim([0, 0.0128])
plt.xlim([0, 1000])
...
for i in range(1001):
    plt.vlines(i, 0, (a[i]), alpha=0.25,color='oldlace')
plt.fill_between(np.arange(0,1001), a, alpha=0.1, color='cornsilk')
plt.ylim([0, 0.0128])
plt.xlim([0, 1000])
